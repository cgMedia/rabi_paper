...
%This system produces a significant departures from the trajectories predicted by solving \cref{eq:rotating liouville} with a prescribed external $\tilde{\vb{E}}_L(\vb{r}, t)$ alone.
%The \qds{} randomly fill a $\SI{0.4}{\micro\meter} \times \SI{0.4}{\micro\meter} \times \SI{0.4}{\micro\meter}$ box illuminated by a pulse calibrated as a \SI{1}{\pico\second} $\pi$-pulse for perfectly resonant, undamped \qds{}.
