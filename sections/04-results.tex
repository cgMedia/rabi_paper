...
\begin{figure}
  ...
  \subfloat[\label{fig:visit}Spatial distribution of $\abs{\vb{P}}$---each colored point depicts the state of one \qd{} with both size and color. Rendered with VisIt~\cite{visit}. \textcolor{red}{Change to 10k figure---simulations in progress}]{\input{figures/visit}}
...
\begin{figure*}
  \centering
  \subfloat{\includegraphics[width=\textwidth]{figures/tube/086_density_00.png}} \\
  \subfloat{\includegraphics[width=\textwidth]{figures/tube/086_density_01.png}} \\
  \subfloat{\includegraphics[width=\textwidth]{figures/tube/086_density_02.png}} \\
  \subfloat{\includegraphics[width=\textwidth]{figures/tube/086_density_03.png}}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figures/tube/086_density_end_on.png}
  \caption{\label{fig:xy tube projcetion}
