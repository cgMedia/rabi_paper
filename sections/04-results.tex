...
To probe the effects of inhomogeneities, \cref{fig:broadened} presents four simulations with normally-distributed transition frequencies characterized by a width parameter.
...
More variation in the detuning distribution, however, quickly serves to destroy these effects leaving only a ``pulse-dominated'' trend.
