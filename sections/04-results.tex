...
\begin{figure}
  \centering
  \subfloat[\label{fig:nearfield box}Spatial distribution of polarization at $t = \SI{12}{\pico\second}$. Each point depicts $\abs{\tilde{\rho}_{01}}^2$ at that location wtih both size and color.]{\input{figures/visit}} \\
  \subfloat[\label{fig:ipr}Inverse participation ratio for the system shown in \cref{fig:nearfield box}. The dashed line indicates the sample time for (a).]{\input{figures/visit_ipr}}
