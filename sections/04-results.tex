...
\begin{figure*}
  \centering
  \includegraphics[width=\textwidth]{figures/tube/086_density_00.png} \\
  \includegraphics[width=\textwidth]{figures/tube/086_density_01.png} \\
  \includegraphics[width=\textwidth]{figures/tube/086_density_02.png} \\
  \includegraphics[width=\textwidth]{figures/tube/086_density_03.png}
  \caption{\label{fig:tubes} Time evolution of $\abs{\vb{P}}^2$ in a $R \times R \times Z$ tube.}
\end{figure*}
