...
Our implementation---based on successful models of other electromagnetic~\cite{otherpapersfromshanker} and acoustic~\cite{Glosser2016} systems---accommodates $10^4$ particles distributed over optically-large regions in three dimensions.
