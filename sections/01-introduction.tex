...
Our implementation---based on successful models of other electromagnetic~\textcolor{orange}{\cite{otherpapersfromshanker}} and acoustic~\cite{Glosser2016} systems---accommodates $10^4$ particles distributed over optically-large regions in three dimensions.
...
\Cref{section:computational approach} presents the details of our algorithm in the context of a global rotating-wave approximation and we offer an implementation of this algorithm at~\textcolor{orange}{\cite{githubpage}}.
