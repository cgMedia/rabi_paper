...
The interpolation coefficients hold $\vb{d}_i \cdot \tilde{\vb{E}}_\text{rad} \cdot \vb{d}_j$ for an interpolatory representation of $\tilde{\vb{E}}_\text{rad}$ (i.e.\ $\tilde{\vb{P}}$ consists only of the interpolatory basis polynomials evaluated at the correct time and contains none of the system dynamcis).
