...
To link $\tilde{\alpha}_{\ell m}$ with the density matrix in \cref{eq:rotating liouville}, we take
\begin{equation}
...
\begin{equation}
  \begin{aligned}
    \tilde{\rho}_\ell(t_{m + 1}) &\leftarrow \mathcal{C}_{W}^{\qty(1)} \, \partial_t \tilde{\rho}_\ell(t_{m+1}) \\
